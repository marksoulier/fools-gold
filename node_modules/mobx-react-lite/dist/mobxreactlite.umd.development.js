(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.mobxReactLite = {}, global.mobx, global.React));
    ...
    if (!((mobx._getGlobalState == null || (_getGlobalState2 = mobx._getGlobalState()) == null ? void 0 : _getGlobalState2.version) >= 7)) {
    ...
    function useObserver(render, baseComponentName = "observed") {
      ...
      const admRef = React__default["default"].useRef(null);
      if (!admRef.current) {
        // First render
      ...
      React__default["default"].useDebugValue(adm.reaction, mobx.getDependencyTree);
      React__default["default"].useSyncExternalStore(
    ...
    const ReactForwardRefSymbol = hasSymbol ? /*#__PURE__*/Symbol.for("react.forward_ref") : typeof React.forwardRef === "function" && React.forwardRef(props => null)["$$typeof"];
    const ReactMemoSymbol = hasSymbol ? /*#__PURE__*/Symbol.for("react.memo") : typeof React.memo === "function" && React.memo(props => null)["$$typeof"];
    ...
    function useLocalObservable(initializer, annotations) {
      return React.useState(() => mobx.observable(initializer(), annotations, {
        autoBind: true
      }))[0];
    }
