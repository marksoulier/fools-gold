...
import { _getGlobalState, getDependencyTree, Reaction, observable } from 'mobx';
...
function createObserverAdministration(baseComponentName) {
  const adm = {
    reaction: null,
    onStoreChange: null,
    stateVersion: Symbol(),
